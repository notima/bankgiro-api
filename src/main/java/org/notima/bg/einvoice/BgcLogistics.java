...
public class BgcLogistics {
    private String id;
    private String name;
    private BgcAddress delivererAddress;
    ...
    @XmlElement
    public BgcAddress getDelivererAddress() {
        return delivererAddress;
    }
    public void setDelivererAddress(BgcAddress delivererAddress) {
